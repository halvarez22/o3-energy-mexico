    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        >
          ...
          <h4 className="font-semibold text-lg">Casa</h4>
        ...
        >
          ...
          <h4 className="font-semibold text-lg">Negocio</h4>
        ...
        >
          ...
          <h4 className="font-semibold text-lg">Aislado</h4>
  ...
  const renderStep2 = () => (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        >
          <h4 className="font-semibold text-lg">Mensual</h4>
        </button>
        ...
        >
          <h4 className="font-semibold text-lg">Bimestral</h4>
        </button>
      </div>
  ...
  const renderStep3 = () => (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        >
          <h4 className="font-semibold text-lg">Financiado</h4>
        ...
        >
          <h4 className="font-semibold text-lg">Contado</h4>
        ...
        >
          <h4 className="font-semibold text-lg">Meses sin Intereses</h4>
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div>
          ...
          <input
            ...
            className="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#f36f20] focus:border-transparent bg-white text-gray-900 placeholder-gray-500"
      ...
      <div>
        ...
        <input
          ...
          className="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#f36f20] focus:border-transparent bg-white text-gray-900 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-[#f36f20] file:text-white hover:file:bg-[#d45e1b]"
        />
